...
describe('byteskode push', function() {
    ...
    it('should be able to send push notification in test and development mode', function(done) {
    ...
    it('should be able to resend push notification(s) in test and development mode', function(done) {
    ...
    it('should be able to queue push notification in test and development mode for later send', function(done) {
